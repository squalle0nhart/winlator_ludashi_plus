...
Java_com_winlator_cmod_renderer_AHBImage_hardwareBufferFromSocket(
...
Java_com_winlator_cmod_renderer_AHBImage_copyHardwareBuffer(
...
JNIEXPORT jlong JNICALL
Java_com_winlator_cmod_renderer_AHBImage_createHardwareBuffer(
...
Java_com_winlator_cmod_renderer_AHBImage_destroyHardwareBuffer(
...
JNIEXPORT jint JNICALL
Java_com_winlator_cmod_renderer_AHBImage_unlockHardwareBuffer(
        JNIEnv *env, jobject obj, jlong ptr)
{
    AHardwareBuffer *ahb = (AHardwareBuffer *)(uintptr_t)ptr;
    if (!ahb) return -1;
...
Java_com_winlator_cmod_renderer_AHBImage_lockHardwareBuffer(
        JNIEnv *env, jobject obj, jlong ptr)
{
...
Java_com_winlator_cmod_renderer_AHBImage_getStride(
        JNIEnv *env, jobject obj, jlong ptr)
{
    AHardwareBuffer *ahb = (AHardwareBuffer *)(uintptr_t)ptr;
    if (!ahb) return -1;
...
JNIEXPORT jshort JNICALL
Java_com_winlator_cmod_renderer_AHBImage_nativeGetWidth(
        JNIEnv *env, jobject obj, jlong ptr)
{
    AHardwareBuffer *ahb = (AHardwareBuffer *)(uintptr_t)ptr;
    if (!ahb) return -1;
...
JNIEXPORT jshort JNICALL
Java_com_winlator_cmod_renderer_AHBImage_nativeGetHeight(
        JNIEnv *env, jobject obj, jlong ptr)
{
    AHardwareBuffer *ahb = (AHardwareBuffer *)(uintptr_t)ptr;
    if (!ahb) return -1;
...
JNIEXPORT void JNICALL
Java_com_winlator_cmod_renderer_AHBImage_nativeCloseFd(JNIEnv *env, jclass clazz, jint fd) {
    if (fd >= 0) close(fd);
}
