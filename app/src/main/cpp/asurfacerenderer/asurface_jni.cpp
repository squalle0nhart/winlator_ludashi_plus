...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_winlator_cmod_renderer_ASurfaceRenderer_nativePrepareCpuSourceBuffers(
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_renderer_ASurfaceRenderer_nativeReleaseCpuSourceBuffers(
        JNIEnv*, jclass, jlong buffer0, jlong buffer1, jlong buffer2)
{
    std::shared_lock lk(g_ctxMutex);
    if (auto* r = g_ctx) {
