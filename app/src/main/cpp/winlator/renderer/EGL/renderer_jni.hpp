...
class JNICache {
    public:
        ...
        jclass displayXViewClass;
        jmethodID displayXOnFramePresented;
        ...
        void init (JavaVM *vm, JNIEnv *env) {
            ...
            jclass displayXViewClass = env->FindClass("com/winlator/cmod/widget/DisplayXServerView");
            ...
            LOAD_METHOD_ID(displayXOnFramePresented, env, displayXViewClass, "onNativeFramePresented", "(I)V");
            ...
            this->displayXViewClass = (jclass)env->NewGlobalRef(displayXViewClass);
        }
};
