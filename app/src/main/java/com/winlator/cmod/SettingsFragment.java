...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String downloadableContentsUrl = preferences.getString("downloadable_contents_url", ContentsManager.REMOTE_PROFILES);
        if (downloadableContentsUrl == null || downloadableContentsUrl.isEmpty() || downloadableContentsUrl.equals(ContentsManager.LEGACY_REMOTE_PROFILES)) {
            downloadableContentsUrl = ContentsManager.REMOTE_PROFILES;
            preferences.edit().putString("downloadable_contents_url", downloadableContentsUrl).apply();
        }
        etDownloadableContentsURL.setText(downloadableContentsUrl);
