...
public class Container {
    ...
    public String getDisplayDriver() {
        return getExtra("displayDriver", DEFAULT_DISPLAY_DRIVER);
    }

    public void setDisplayDriver(String displayDriver) {
        putExtra("displayDriver", displayDriver != null && !displayDriver.isEmpty()
                ? displayDriver : DEFAULT_DISPLAY_DRIVER);
    }
