...
public class GrabManager implements WindowManager.OnWindowModificationListener {
    ...
    private void activatePointerGrab(Window window, EventListener eventListener, boolean ownerEvents,
                                     boolean releaseWithButtons, Window confineToWindow) {
        if (this.window == null) {
    ...
    public void activatePointerGrab(Window window, boolean ownerEvents, Bitmask eventMask,
                                    XClient client, Window confineToWindow) {
