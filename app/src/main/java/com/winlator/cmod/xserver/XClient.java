...
public class XClient implements XResourceManager.OnResourceLifecycleListener {
    ...
    public void freeResources() {
        try (XLock lock = xServer.lockAll()) {
            ...
            GLXExtension glx = xServer.getExtension(GLXExtension.MAJOR_OPCODE);
            if (glx != null) glx.freeClientResources(this);

            XCompositeExtension composite =
                    xServer.getExtension(XCompositeExtension.MAJOR_OPCODE);
            if (composite != null) composite.freeClientResources(this);
